...
class ObrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create obra" do
    assert_difference('Obra.count') do
      post obras_url, params: { obra: { descricao: @obra.descricao, estilo_obra: @obra.estilo_obra, nome: @obra.nome, preco: @obra.preco, quantidade: @obra.quantidade } }
    end
  ...
  test "should update obra" do
    patch obra_url(@obra), params: { obra: { descricao: @obra.descricao, estilo_obra: @obra.estilo_obra, nome: @obra.nome, preco: @obra.preco, quantidade: @obra.quantidade } }
